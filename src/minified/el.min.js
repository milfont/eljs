...
/* jquery.el.js */
if(typeof Array.prototype.last=="undefined")Array.prototype.last=function(){return this.length>0?this[this.length-1]:-1};Object.defineProperty(Object.prototype,"trying",{enumerable:!1,value:function(a){return function c(a,d){var f=a.split("."),d=d[f.shift()];return f.length>0&&typeof d!=="undefined"?c(f.join("."),d):d}(a,this)}});
(function(a){var g=a("<div>"),c={},i=/\$\{(\s*?)\partial\(([^}]+)\)\}/g,d=function(b){b="div#"+b.replace(/\"/g,"").replace(/\./g,"\\.").toString();return g.find(b).html().toString()},f=function(b){return c[b]||c["'"+b+"'"]||c['"'+b+'"']};a.extend({getTemplates:function(){return c},clearTemplates:function(){g.html("");c={}},compileTemplates:function(b,h){var j=b.helpers||{};j.partial=function(k){for(var e=c[b.sprite].json,a="",d=f(k),e=e.trying(k),h=0;h<e.length;h++){var j=k.split(".").last().replace(/s$/i,
"").toLowerCase(),g={};g[j]=e[h];a+=d.parse(g)}return a};a.get(b.url,function(a){g.append(a);if(a=a.match(i))for(var e=0;e<a.length;e++){var f=a[e].replace(i,"$2"),l=d(f);c[f]=(new Eljs({template:l})).compile()}c[b.sprite]=(new Eljs({template:d(b.sprite),helpers:j})).compile();typeof h==="function"&&h(c[b.sprite])})}});a.fn.extend({render:function(b,c,d){var g=a(this),e=function(a){g.append(a.parse(b))},i=f(c);i?e(i):a.compileTemplates({url:d,sprite:c},e);return g}})})(jQuery);