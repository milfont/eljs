/* el.js */
function Eljs(a){this.version="0.2.0";this.pattern=/\$\{([^}]+)\}/g;this.compiled=!1;this.compiledTemplate="";this.cache={};this.json={};this.template="";this.processConfig=function(a){if(a)this.json=a.json||{},this.template=a.template||""};this.processConfig(a);var f=function e(a,d){for(var b in d)"object"===typeof d[b]&&"undefined"!==typeof a[b]?e(a[b],d[b]):a[b]=d[b];return a},g,h=function(e){f(this,e);f(this,g());a&&a.helpers&&f(this,a.helpers);var c=function(){return function(a){return(a=this["_ELJS_"+
