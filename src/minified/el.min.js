...
"").toLowerCase(),h={};h[i]=e[g];a+=d.parse(h)}return a};a.get(b.url,function(a){i.append(a);if(a=a.match(h))for(var e=0;e<a.length;e++){var f=a[e].replace(h,"$2"),k=d(f);c[f]=(new Eljs({template:k})).compile()}c[b.sprite]=(new Eljs({template:d(b.sprite),helpers:g})).compile();typeof b.callback==="function"&&b.callback(c[b.sprite])})}});a.fn.extend({render:function(b){var c=a(this),d=function(a){return function(d){c.append(d.parse(b.json));a&&a(c)}}(b.callback);b.callback=d;var e=f(b.sprite);e?d(e):
